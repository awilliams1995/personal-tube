...
app.get("/channels",function(req,res){
    ...
    .then(function(dbReview) {
      ...
      res.render("channelpage",{id:dbReview.thumbnail,result:[{thumbnail:dbReview.thumbnail,reviews,rating:`<i class="fa fa-star"></i>`.repeat(Math.round(ratingValue)),name:dbReview.name,channelDescription:dbReview.channelDescription}]});
        });
  });
